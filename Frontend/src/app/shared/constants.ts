export const constants = {
  USER_AUTH_SERVICE_URL: 'http://localhost:8081/api/v1.0/moviebooking',
  MOVIE_CATALOG_SERVICE_URL: 'http://localhost:8082/api/v1.0/moviebooking',
  BOOKING_SERVICE_URL: 'http://localhost:8083/api/v1.0/moviebooking',
  ADMIN_SERVICE_URL: 'http://localhost:8084/api/v1.0/moviebooking',
  SECURITY_QUESTIONS: [
